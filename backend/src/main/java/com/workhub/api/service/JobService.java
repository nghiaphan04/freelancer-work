...
public class JobService {
    ...
    public ApiResponse<JobApplicationResponse> submitWork(Long jobId, Long userId, String url, String note) {
        ...
        return ApiResponse.success("Đã nộp sản phẩm thành công", buildApplicationResponse(application));
    }
    ...
    public ApiResponse<JobApplicationResponse> requestRevision(Long jobId, Long userId, String note) {
        ...
        return ApiResponse.success("Đã yêu cầu freelancer chỉnh sửa sản phẩm", buildApplicationResponse(application));
    }
    ...
    public ApiResponse<JobApplicationResponse> getWorkSubmission(Long jobId, Long userId) {
        ...
        return ApiResponse.success("Thành công", buildApplicationResponse(application));
    }
